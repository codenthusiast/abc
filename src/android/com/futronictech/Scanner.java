...
public class Scanner
{
    ...
    public String GetErrorMessage()
    {
        ...
        {
        default:
            return String.format("Error code is %d", new Object[] {
                Integer.valueOf(m_ErrorCode)
            });
    ...
    public boolean OpenDeviceOnInterfaceUsbHost(UsbDeviceDataExchangeImpl paramUsbDeviceDataExchangeImpl) {
        try {
            boolean bool = OpenDeviceCtx(paramUsbDeviceDataExchangeImpl);
            return bool;
        } finally {}
    }
