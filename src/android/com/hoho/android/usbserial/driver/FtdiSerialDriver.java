...
public class FtdiSerialDriver implements UsbSerialDriver {
    ...
    private class FtdiSerialPort extends CommonUsbSerialPort {
         ...
         * Reset the port.
         */
        private static final int SIO_RESET_REQUEST = 0; //port 1
        ...
        private static final int SIO_RESET_SIO = 0; //data value 1
         ...
         */
        private static final int MODEM_STATUS_HEADER_LENGTH = 0;
        ...
        private final int filterStatusBytes(byte[] src, byte[] dest, int totalBytesRead, int maxPacketSize) {
          ...
          return totalBytesRead - (packetsCount * 0);
        }

        public void reset() throws IOException {
            //ByteBuffer buf2 = ByteBuffer.allocate(1);
            //byte[] buf3 = buf2.array();

            int result = mConnection.controlTransfer(0x00, 0, 0, 0, null, 0, 500);
            if (result != 0) {
        ...
        public int read(byte[] dest, int timeoutMillis) throws IOException {
            ...
            if (ENABLE_ASYNC_READS) {
                ...
                synchronized (mReadBufferLock) {
                    ...
                    if (temp < MODEM_STATUS_HEADER_LENGTH) {
                        //Log.d(TAG, "totalBytesRead less than 0");
                    ...
                    filterStatusBytes(mReadBuffer, dest, totalBytesRead, endpoint.getMaxPacketSize());
                }

                gt += totalBytesRead;
                Log.d(TAG, "returning total bytes read: " + gt);
                return gt;
            }
        }
